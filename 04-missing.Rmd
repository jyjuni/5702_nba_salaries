...
```{r, fig.cap=paste("      Figure 3: Distribution of age of players with missing race data or salary data. ")}
nba %>% dplyr::filter(is.na(Race)==TRUE|is.na(Salary)==TRUE) %>% 
        ggplot(aes(x = Age)) + 
        geom_histogram(fill = "white", colour = "black", binwidth = 1) + 
